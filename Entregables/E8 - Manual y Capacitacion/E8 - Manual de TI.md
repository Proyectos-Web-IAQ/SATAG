...
9. **"Instalado por"** muestra su usuario con la nota **"usuario de esta sesión"** y no se escribe: la instalación queda registrada a nombre de la cuenta con la que entró, con la fecha y la hora exactas. **Si va a instalar otra persona, que entre al panel con su propia cuenta.**
...
- **"Instalado por" no se escribe:** la instalación queda a nombre de la cuenta con la que se inició sesión, con su fecha y hora exactas, igual que el cobro en Administración. En un equipo compartido, **cada persona entra con su propia cuenta antes de instalar** y toca **"Salir"** al terminar.
- **"Atendido por"** (actualizar datos y dar de baja) se prellena con el nombre derivado del correo de la sesión y todavía es editable; no se conserva entre sesiones, a propósito. Corríjalo si quien atiende es otra persona. Si lo deja en blanco, el movimiento se registra a nombre de **"TI"**, sin nombre de persona.
