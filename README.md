...
- [x] Auth del panel + reset de contraseña — *Est. 0.5 d* ✅ · login real con Supabase Auth (correo/contraseña), sesión persistente y recuperación por correo (`/admin/reset-password`). Falta config del dashboard (usuario admin, Redirect URLs, MFA) — ver [supabase/README](supabase/README.md#auth-del-panel-administrativo)
