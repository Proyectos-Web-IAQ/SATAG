...
| CC-12 | 03/07/26 | Responsable / investigación legal | Endurecer Supabase: RLS por rol, RPC controlada, Storage privado y MFA admin | Reformulación de seguridad / +1 d / $0 | 🔴 Alta | Aprobado | M. Á. González | Implementado 15/07 (bloques 20, 27, 29, 30: roles admin/ti/consulta/super + `aal2`) y **completado 28/07** con el bloque 43, que restringe por rol la escritura de catálogos, documentos legales y el bucket de firmas. Único resto: URLs firmadas cuando el panel muestre la firma (SC-008) |
