...
| 1.5.3 🆕 | Caja / POS | **HECHO:** folio de recibo automático (bloque 32) + **corte de caja / finanzas** (bloque 42 + pestaña Finanzas, 22-jul-2026): caja actual, acumulados de venta, corte inmutable con conciliación de efectivo e identidad de quien corta | Implementado | Solo POS/facturación (CFDI) queda fuera de alcance |
