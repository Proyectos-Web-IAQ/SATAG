...
| **Firmas borradas** (cuántas imágenes había y a qué horas se subieron) | **No se vació el almacenamiento.** Al 15-sep hay 18 imágenes: 7 de las familias del lunes y 11 sin expediente — 1 del 18-ago (10:17), 5 del 10-sep (13:34, 14:29, 14:43, 15:04 y 15:22), 3 del 11-sep (14:04, 15:47 y 15:50) y 2 del 14-sep (07:57 y 08:05, pruebas antes de abrir). Las del 10 y 11-sep coinciden con los incidentes del alta: pueden ser pruebas o altas rechazadas. **Ninguna es posterior a la apertura.** Las 11 se borraron a mano desde el tablero el 15-sep. **Comprobado el 17-sep con una consulta de solo lectura contra producción:** no queda ninguna imagen de firma sin expediente. El único objeto del bucket que no empata con una aceptación es `.emptyFolderPlaceholder`, el archivo vacío que Supabase Storage crea al hacer una carpeta desde el tablero; no es una firma y no contiene datos personales. Queda como está. **Nota para quien repita la comprobación:** hay que excluirlo del conteo o parece un huérfano — `and o.name not like '%.emptyFolderPlaceholder'`. |
| **Decisión con Miguel** (salida el lunes 14-sep: sí o no; acepta los riesgos de la sección 8) | **Salida el lunes 14: sí.** SATAG operó ese día con familias reales y Miguel instaló uno de los TAGs. **Confirmado por Gerardo el 17-sep: Miguel aceptó los riesgos de la sección 8**, y la constancia es la propia salida a producción — decidió con esos riesgos sobre la mesa y el sistema abrió. No hay firma en este documento, y no se va a fabricar una a posteriori: se registra como aceptación verbal del responsable, con la operación del 14-sep como evidencia. |
