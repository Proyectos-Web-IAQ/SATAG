...
| H6 | Despliegue, entrega y aceptación | 28-jul-2026 (meta inicial 24-jul; ajustada a ~03-ago) | 🔄 Ya desplegado en el entorno de trabajo (Vercel) desde `main`; faltan entrega, manual y aceptación formal |
...
- Elegir **tecnología, arquitectura y hosting**. Decisión preliminar: reutilizar la base técnica de
  ...
  *(Ejecutado 20-jul-2026: se reutilizó el stack, pero el despliegue actual es **Vercel desde `main`**
  —cada push publica en el entorno de trabajo—, sin GitHub Action ni FTPS. El principio "push a `main` =
  publicación automática" se mantiene; cambia el vehículo.)*
